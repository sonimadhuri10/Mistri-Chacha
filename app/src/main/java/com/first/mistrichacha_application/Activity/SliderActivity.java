...
public class SliderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.slider_screen_layout);
        ...
        screens = new int[]{
                R.layout.welcome_first_screen,
                R.layout.welcome_second_screen,
                R.layout.welcome_third_screen,
        };
