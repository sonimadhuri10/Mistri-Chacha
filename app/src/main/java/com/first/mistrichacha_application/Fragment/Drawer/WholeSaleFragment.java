...
public class WholeSaleFragment extends Fragment implements SearchView.OnQueryTextListener {
    ...
    LatestProductAdapter trendingAdapter ;
    LinearLayout llmain ;
    ...
    private void retro() {
        try{
            if (!cd.isConnectingToInternet()) {
                ...
                Call<LatestProductModel> call = apiInterface.getWholesaleProducts(sd.getLatitude(),sd.getLongitude());
                call.enqueue(new Callback<LatestProductModel>() {
                    ...
                    public void onResponse(Call<LatestProductModel> call, retrofit2.Response<LatestProductModel> response) {
                        ...
                        if (pro.productlist.size() == 0) {
                            ...
                            trendingAdapter = new LatestProductAdapter(al,getActivity());
