...
public class DiscountProducts extends Fragment implements SearchView.OnQueryTextListener{
    ...
    LatestProductAdapter discountAdapter ;
    LinearLayout llmain ;
    ...
    private void retro() {
        try {
            if (!cd.isConnectingToInternet()) {
                ...
                Call<LatestProductModel> call = apiInterface.getDiscountproducts(sd.getLatitude(),sd.getLongitude());
                call.enqueue(new Callback<LatestProductModel>() {
                    ...
                    public void onResponse(Call<LatestProductModel> call, retrofit2.Response<LatestProductModel> response) {
                        ...
                        if (pro.productlist.size() == 0) {
                            ...
                            discountAdapter = new LatestProductAdapter(al,getActivity());
