...
public class TrendingProducts  extends Fragment implements SearchView.OnQueryTextListener {
    ...
    private void retro() {
        try{
            if (!cd.isConnectingToInternet()) {
                ...
                Call<LatestProductModel> call = apiInterface.getTrendingproducts(sd.getLatitude(),sd.getLongitude());
